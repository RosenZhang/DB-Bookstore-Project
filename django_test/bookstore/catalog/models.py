...
class Book(models.Model):
    ...
    isbn = models.CharField('ISBN', max_length=13,
                             help_text='13 Character <a href="https://www.isbn-international.org/content/what-isbn">ISBNumber</a>')
...
class MyModelName(models.Model):
    ...
    type can take arguments that further specify storage details
    ...
    class Meta:
        ...
        # control default order of records returned when query
    # Methods
    def get_absolute_url(self):
        """
